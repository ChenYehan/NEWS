...
public class MainActivity extends AppCompatActivity {
    ...
    public void requestNew(int itemName){
        ...
        //跳转至此实现 onFailure 与 onResponse 方法
    ...
    private String response(int itemName){
        String address = "https://api.tianapi.com/social/?key=6d278933bef7b41249e0c8be4825f7b9&num=50&rand=1";
        switch(itemName){
            case ITEM_SOCIETY:
                break;
            case ITEM_COUNTY:
